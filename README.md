...
- **MakerScreenXVI** a library for interfacing a 16x2 LCD to an MCU, with multiple helper utilities and object management assets for custom drawing and pseudo-animations, along with numerous examples
